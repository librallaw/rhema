                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13"> Upload Reasons</p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form method="post" action="{{ route('uploadReason') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-text"></i></div>
                                                <input type="text" class="form-control" id="exampleInputTitle1" placeholder="Reason 1" name="reason1">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-text"></i></div>
                                                <input type="text" placeholder="Reason 2" name="reason2" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-text"></i></div>
                                                <input type="text" placeholder="Reason 3" name="reason3" class="form-control">
                                            </div>
                                        </div>
