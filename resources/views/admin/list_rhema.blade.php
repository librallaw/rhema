            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Rhema</h3>
                            <p class="text-muted m-b-30">All Rhema</p>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    @foreach($rhemas as $rhema)
                                        <tr>
                                            ...
                                            <td><a href="{{url('editRhema/'.$rhema->id)}}"><span class="label label-rouded label-warning"> Edit</span></a></td>
                                            <td></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
