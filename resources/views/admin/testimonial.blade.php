                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13"> Upload Testimonial</p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form method="post" action="{{ route('uploadTestimonial') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-text"></i></div>
                                                <input type="text" class="form-control" id="exampleInputTitle1" placeholder="" name="country">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-text"></i></div>
                                                <textarea class="form-control" id="exampleInputTitle1" placeholder="" name="testimony" ></textarea>
                                            </div>
                                        </div>
