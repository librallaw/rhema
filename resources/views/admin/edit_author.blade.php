                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13"> Edit Author</p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form method="post" action="{{url('/edit/author/'.$author->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputTitle">Name</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-text"></i></div>
                                                <input type="text" class="form-control" id="exampleInputTitle1" value="{{$author->name}}" name="name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-text"></i></div>
                                                <textarea cols="16" rows="4" class="ckeditor form-control" id="exampleInputTitle1" name="body">{{$author->body}}</textarea>
                                            </div>
                                        </div>
