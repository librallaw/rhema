                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30">All Testimonials</p>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    @foreach($tests as $test)
                                        <tr>
                                            ...
                                            <td><a href="{{url('editTest/'.$test->id)}}"><span class="label label-rouded label-warning"> Edit</span></a> || <a href="{{ url('delete/testimonial/'.$test->id) }}"> <span class="label label-rouded label-danger">Delete</span></a></td>
                                            <td></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
