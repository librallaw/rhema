...
<head>
    <title>Lightbook - Bootstrap 4 premium SinglePage and MultePage HTML template</title>
    <meta charset="utf-8">
    <!--[if IE]>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        <h1 class="small-title">Sponsorship </h1>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="row c-gutter-60">
                            ...
                            <div class="col-lg-6 col-xl-5">
                                <div class="vertical-item hero-bg text-center team-layout content-padding">
                                    ...
                                    <div class="item-content">
                                        <h5 class="mb-0">Everyone a sponsor</h5>
                            ...
                            <div class="col-lg-6 offset-xl-1">
                                ...
                                <p class="excerpt">
                                    “The Lord gave the Word; great was the company of those that published (sponsor) it”.  (emphasis ours)

                                </p>

                                <p class="first-letter">
                                    We send in free copies of Rhema for Living into the following places, free, paid for by your sponsorship seeds.

                                </p>


                                <ul class="list-styled">
                                    <li> Schools (Elementary)</li>
                                    <li>Colleges (Campuses)</li>
                                    <li>Orphanages</li>
                                    <li>Offices (Government & Private)</li>
                                    <li>Prisons</li>
                                    <li>Restaurants & Eateries</li>
                                    <li> Hotels & guest houses</li>
                                </ul>
                                <p>
                                    You tell us, where you want us to go to and your darling devotional will be there.</p>
                                <h4>Global Sponsorship Categories - WHY and BENEFITS </h4>
                                <p>
                                ...
                                <p>
                                    RFL as a major part of the ground force of our global evangelism strategy.
                                ...
                                <div class="ls ms p-40 p-lg-50 border-r-def">
                                    <form class="contact-form c-mb-50" action="/">
                                        ...
                                        <div class="wrap-forms">
                                            <div class="row">
                                                <div class="col-12">
                                                    <button type="submit" name="contact_submit" class="btn btn-maincolor">Give</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
