...
" />
    ...
    <!-- ========== Page Title ========== -->
    <title>Outreaches - Rhema for Living</title>
...
<body>
    ...
    <!-- Start Breadcrumb 
    ============================================= -->
    <div class="breadcrumb-area shadow dark bg-fixed text-center padding-xl text-light" style="background-image: url('assets/img/banner/outreach_banner1.jpg');">
        <div class="container">
            <div class="row">
                            ...
                            <div id="portfolio-grid" class="portfolio-items col-3">
                                <div class="pf-item branding photography">
                                    <div class="item-inner">
                                        <img src="assets/img/gallery/outreach1.jpg" alt="Thumb"/>
                                        <div class="overlay">
                                            <div class="view-list">
                                                <h4>Blood Donate</h4>
                                ...
                                <div class="pf-item video development">
                                    <div class="item-inner">
                                        <img src="assets/img/gallery/outreach2.jpg" alt="Thumb"/>
                                        <div class="overlay">
                                            <div class="view-list">
                                                <h4>Rebuild Home</h4>
                                ...
                                <div class="pf-item design photography">
                                    <div class="item-inner">
                                        <img src="assets/img/gallery/outreach3.jpg" alt="Thumb"/>
                                        <div class="overlay">
                                            <div class="view-list">
                                                <h4>Water Collect</h4>
                                ...
                                <div class="pf-item branding video">
                                    <div class="item-inner">
                                        <img src="assets/img/gallery/outreach4.jpg" alt="Thumb"/>
                                        <div class="overlay">
                                            <div class="view-list">
                                ...
                                <div class="pf-item design photography">
                                    <div class="item-inner">
                                        <img src="assets/img/gallery/outreach5.jpg" alt="Thumb"/>
                                        <div class="overlay">
                                            <div class="view-list">
                                                <h4>Help Poor</h4>
                                ...
                                <div class="pf-item branding design development">
                                    <div class="item-inner">
                                        <img src="assets/img/gallery/outreach6.jpg" alt="Thumb"/>
                                        <div class="overlay">
                                            <div class="view-list">
